...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/ov2/zhaoxiuwei/LLaVA-OneVision-2.0/examples/llava_onevision2/quick_start_video_2b/output/sft_ckpt-dcp-to-dcp_continue_train/"}
